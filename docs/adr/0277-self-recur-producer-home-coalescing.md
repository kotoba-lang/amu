...
These are structural and semantic-execution results, not qualified wall-clock
evidence. They do not establish a runtime speed improvement, Rust/LLVM parity,
or a “world fastest” claim.
