# ADR 0264: state and log :wasm-aot are the in-component store and ring
...
Unlike clock (ADR 0263), these kits have no host clock/network to import.
...
- ADR 0263 — clock WASI kit schema
