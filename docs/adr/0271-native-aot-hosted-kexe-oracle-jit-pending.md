# ADR 0271: native-aot hosted kexe clock oracle; production and jit stay pending

Status: accepted

Supersedes the “no executable path” sentence of ADR 0270. Kit flags and
backend-wide native status from ADR 0270 are unchanged.
