# ADR 0270: native-aot / jit stay pending — no C-free syscall path
...
`backend-qualification-test`). Closing wasm-aot for http/llm (ADR 0268 /
...
ADR 0271 adds a hosted kexe clock-v1 **oracle** (nested codec + host
