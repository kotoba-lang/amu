...
| H-C2 | evidence | host busy (load1 8.95, 1m/5m/15m = 8.95/7.85/14.79, macOS 26.4, 22:16 JST) - quiet gate not met, no measurement run; policy: log busy only. [amu-bench]  2026-09-22 05:39 JST falsify tick: host busy (load1 36.65, load5 36.81, load15 43.09, threshold 7.5), no measurement attempted; NEXT remains H-C2 (amu-falsify) 2026-09-23 11:5x JST falsify tick: host busy (load1 10.28-15.66 sustained 11:50:05-11:52:06, load5 ~9.9-11.3, load15 ~9.6-10.1, 13 probes at 10s, threshold 7.5, never below 7.5 in 2 min; pre-run monitor NEXT = H-C2) - quiet gate unmet, H-C2 timed hand-patch A/B refused, no measurement attempted, n=0. (amu-falsify) | 2026-09-23 22:1x JST bench tick: host busy (load1 33.91 / 5m 35.22 / 15m 33.67 live at 22:20:46, pre-run monitor load1 34.72, threshold 7.5), no measurement attempted, n=0; NEXT is still H-C2 quiet-host bench/perfgate (amu-bench) 2026-09-23 23:39 JST falsify tick: host busy (load1 30.76 live at 23:39:56, 5m 31.72, 15m 30.49; pre-run monitor load1 38.45 at 23:38, threshold 7.5), no measurement attempted, n=0; NEXT remains H-C2 (amu-falsify)
