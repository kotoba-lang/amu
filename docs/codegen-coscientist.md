...
| H-C2 | evidence | host busy (load1 8.95, 1m/5m/15m = 8.95/7.85/14.79, macOS 26.4, 22:16 JST) - quiet gate not met, no measurement run; policy: log busy only. [amu-bench] | | host-busy ts=2026-09-07 06:45 JST load1=53.96 (quiet gate>7.5) falsify-tick 2026-09-07 06:4x: no measurement | 2026-09-07 12:30 JST falsify tick: host busy (load1 62.25, load5 81.82, load15 70.48, up 2 days, 13 users, threshold 7.5), no measurement attempted; NEXT は H-C2 のまま | 2026-09-07 16:02 JST falsify tick: host busy (load1 28.23, load5 20.04, load15 23.16, threshold 7.5), no measurement attempted; NEXT は H-C2 のまま
