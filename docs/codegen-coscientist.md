...
| H-C2 | evidence | host busy (load1 8.95, 1m/5m/15m = 8.95/7.85/14.79, macOS 26.4, 22:16 JST) - quiet gate not met, no measurement run; policy: log busy only. [amu-bench]  2026-09-22 05:39 JST falsify tick: host busy (load1 36.65, load5 36.81, load15 43.09, threshold 7.5), no measurement attempted; NEXT remains H-C2 (amu-falsify)
