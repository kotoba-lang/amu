...
| H-C2 | evidence | host busy (load1 8.95, 1m/5m/15m = 8.95/7.85/14.79, macOS 26.4, 22:16 JST) - quiet gate not met, no measurement run; policy: log busy only. [amu-bench] | | host-busy ts=2026-09-07 06:45 JST load1=53.96 (quiet gate>7.5) falsify-tick 2026-09-07 06:4x: no measurement
