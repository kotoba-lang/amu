...
struct kexe_context_v7 {
  uint64_t version;
  uint64_t fuel;
  uint64_t allow[4];
  int64_t (*cap_call)(struct kexe_context_v7 *, uint64_t, int64_t);
  int64_t (*pair_new)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*pair_first)(struct kexe_context_v7 *, int64_t);
  int64_t (*pair_second)(struct kexe_context_v7 *, int64_t);
  ...
  int64_t (*kgraph_assert)(struct kexe_context_v7 *, int64_t, int64_t, int64_t);
  int64_t (*kgraph_get)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*kgraph_count)(struct kexe_context_v7 *, int64_t);
  int64_t (*kgraph_entity_at)(struct kexe_context_v7 *, int64_t, int64_t);
  ...
  int64_t (*string_equal)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*string_concat)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*typed_cap_call)(struct kexe_context_v7 *, uint64_t, uint64_t,
                            uint64_t, int64_t);
  ...
  int64_t (*string_substring)(struct kexe_context_v7 *, int64_t, int64_t,
                              int64_t);
  ...
  int64_t (*string_code_point_at)(struct kexe_context_v7 *, int64_t, int64_t);
  ...
  int64_t (*vector_new_empty)(struct kexe_context_v7 *);
  int64_t (*vector_conj)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*vector_count)(struct kexe_context_v7 *, int64_t);
  int64_t (*vector_at)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*vector_assoc)(struct kexe_context_v7 *, int64_t, int64_t, int64_t);
  int64_t (*vector_drop)(struct kexe_context_v7 *, int64_t, int64_t);
  ...
  int64_t (*vector_alloc)(struct kexe_context_v7 *, int64_t);
  int64_t (*vector_assoc_in_place)(struct kexe_context_v7 *, int64_t, int64_t,
                                   int64_t);
   ...
   * at 216. */
  int64_t (*string_index_of)(struct kexe_context_v7 *, int64_t, int64_t);
  ...
  int64_t (*arena_enter)(struct kexe_context_v7 *);
  int64_t (*arena_leave)(struct kexe_context_v7 *);
  ...
  int64_t (*string_compare)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*string_fold_ascii)(struct kexe_context_v7 *, int64_t);
  int64_t (*string_find_blank)(struct kexe_context_v7 *, int64_t, int64_t);
  int64_t (*string_skip_blank)(struct kexe_context_v7 *, int64_t, int64_t);
...
struct kexe_shared_v7 {
  struct kexe_context_v7 context;
  int64_t result;
  uint64_t completed;
  uint64_t pair_used;
...
_Static_assert(offsetof(struct kexe_shared_v7, region_pool) +
                   KEXE_REGION_POOL_BYTES == sizeof(struct kexe_shared_v7),
               "region pool must be the last field of the shared mapping");
_Static_assert(offsetof(struct kexe_context_v7, fuel) == 8, "fuel ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, allow) == 16, "allow ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, cap_call) == 48, "cap ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, pair_new) == 56, "pair ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, pair_first) == 64, "pair ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, pair_second) == 72, "pair ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, kgraph_assert) == 80, "kgraph ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, kgraph_get) == 88, "kgraph ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, kgraph_count) == 96, "kgraph ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, kgraph_entity_at) == 104, "kgraph ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, typed_cap_call) == 128, "typed cap ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_equal) == 112, "string ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_concat) == 120, "string ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_substring) == 136, "string ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_code_point_at) == 144, "string ABI drift");
...
_Static_assert(sizeof(((struct kexe_shared_v7 *)0)->pairs)
                   == KEXE_PAIR_MAX * sizeof(struct kexe_pair_v1),
               "pair arena size drift");
_Static_assert(sizeof(((struct kexe_shared_v7 *)0)->datoms) == 98304,
               "kgraph arena size drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_new_empty) == 152, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_conj) == 160, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_count) == 168, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_at) == 176, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_assoc) == 184, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_drop) == 192, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_alloc) == 200, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, vector_assoc_in_place) == 208, "vector ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_index_of) == 216, "string ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, arena_enter) == 224, "region ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, arena_leave) == 232, "region ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_compare) == 240, "text ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_fold_ascii) == 248, "text ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_find_blank) == 256, "text ABI drift");
_Static_assert(offsetof(struct kexe_context_v7, string_skip_blank) == 264, "text ABI drift");
_Static_assert(sizeof(((struct kexe_shared_v7 *)0)->string_pool) == KEXE_STRING_POOL_MAX,
               "string pool size drift");
_Static_assert(sizeof(((struct kexe_shared_v7 *)0)->vectors) == 65536,
               "vector table size drift");
_Static_assert(sizeof(((struct kexe_shared_v7 *)0)->vector_items) == 524288,
...
static int64_t checked_cap_call(struct kexe_context_v7 *context,
                                uint64_t cap_id, int64_t value) {
  if (context == NULL || context->version != 7 || cap_id > 255 ||
...
static int64_t checked_pair_new(struct kexe_context_v7 *context,
                                int64_t first, int64_t second) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
 ...
 * -Wall -Wextra -Werror. */
  if (context == NULL || context->version != 7 ||
...
static int64_t checked_pair_get(struct kexe_context_v7 *context,
                                int64_t handle, int second) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7 || handle <= 0 ||
...
static int64_t checked_pair_first(struct kexe_context_v7 *context, int64_t handle) {
  return checked_pair_get(context, handle, 0);
}

static int64_t checked_pair_second(struct kexe_context_v7 *context, int64_t handle) {
...
static struct kexe_vector_v1 *resolve_vector(struct kexe_shared_v7 *shared,
                                             int64_t handle) {
...
static int64_t intern_vector(struct kexe_shared_v7 *shared,
...
static int64_t checked_vector_new_empty(struct kexe_context_v7 *context) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
  int64_t handle = intern_vector(shared, shared->vector_item_used, 0);
  if (handle == 0) { raise(SIGILL); return 0; }
  return handle;
}

static int64_t checked_vector_count(struct kexe_context_v7 *context,
                                    int64_t handle) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_vector_at(struct kexe_context_v7 *context,
...
static int64_t checked_vector_conj(struct kexe_context_v7 *context,
...
static int64_t checked_vector_assoc(struct kexe_context_v7 *context,
                                    int64_t handle, int64_t index,
                                    int64_t item) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_vector_alloc(struct kexe_context_v7 *context,
                                    int64_t count) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
 ...
 * compiler believed. */
static int64_t checked_vector_assoc_in_place(struct kexe_context_v7 *context,
                                             int64_t handle, int64_t index,
                                             int64_t item) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_vector_drop(struct kexe_context_v7 *context,
...
static int64_t checked_kgraph_assert(struct kexe_context_v7 *context,
...
static int64_t checked_kgraph_get(struct kexe_context_v7 *context,
                                  int64_t e, int64_t a) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) {
    raise(SIGILL);
...
static int kgraph_entity_seen_before(const struct kexe_shared_v7 *shared,
...
static int64_t checked_kgraph_count(struct kexe_context_v7 *context, int64_t a) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) {
    raise(SIGILL);
    return 0;
...
static int64_t checked_kgraph_entity_at(struct kexe_context_v7 *context,
                                        int64_t a, int64_t index) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7 || index < 0) {
    raise(SIGILL);
    return 0;
  }
  int64_t seen = -1;
...
static const uint8_t *resolve_string_bytes(struct kexe_context_v7 *context,
...
static int ensure_valid_string(struct kexe_context_v7 *context, int64_t handle,
 ...
 * validated strings. */
static int64_t mark_validated(struct kexe_context_v7 *context, int64_t handle) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
...
static int allocate_host_pair(struct kexe_shared_v7 *shared,
 ...
 * working. */
static int parse_guest_arg(struct kexe_shared_v7 *shared,
...
static const uint8_t *inspect_string_result(const struct kexe_shared_v7 *shared,
...
static int inspect_record_result(const struct kexe_shared_v7 *shared,
...
static int inspect_tagged_i64_result(const struct kexe_shared_v7 *shared,
...
static int inspect_variant_result(const struct kexe_shared_v7 *shared,
...
static int peek_pair(struct kexe_context_v7 *context, int64_t handle,
...
static int peek_vector(struct kexe_context_v7 *context, int64_t handle,
                       uint64_t *length, const int64_t **items) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  struct kexe_vector_v1 *vector;
  if (context == NULL || context->version != 7) return 0;
...
static const uint8_t *peek_string_bytes(struct kexe_context_v7 *context,
                                        int64_t offset, int64_t length) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7 || length < 0) return NULL;
  if (offset >= 0) {
...
static int valid_string_handle(struct kexe_context_v7 *context, int64_t value) {
...
static int read_string_handle(struct kexe_context_v7 *context, int64_t value,
...
static int64_t intern_utf8(struct kexe_context_v7 *context,
...
static int valid_dataspace_request(struct kexe_context_v7 *context,
                                   int64_t value) {
...
static int valid_dataspace_result(struct kexe_context_v7 *context,
                                  int64_t value) {
  int64_t ordinal, payload;
  if (!peek_pair(context, value, 0, &ordinal) ||
      !peek_pair(context, value, 1, &payload)) return 0;
...
static int valid_ui_node(struct kexe_context_v7 *context, int64_t node) {
...
static int valid_ui_nodes(struct kexe_context_v7 *context, int64_t nodes) {
  uint64_t length = 0, i;
...
static int valid_ui_commit_request(struct kexe_context_v7 *context,
                                   int64_t value) {
...
static int valid_ui_commit_result(struct kexe_context_v7 *context,
                                  int64_t value) {
...
static int valid_ui_event_request(struct kexe_context_v7 *context,
                                  int64_t value) {
  int64_t after, tail;
...
static int valid_ui_event(struct kexe_context_v7 *context, int64_t value) {
...
static int valid_ui_event_result(struct kexe_context_v7 *context,
                                 int64_t value) {
  int64_t tag, payload;
...
static int64_t intern_pool_string(struct kexe_context_v7 *context,
                                  const char *text) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
...
static int valid_clock_request(const struct kexe_shared_v7 *shared, int64_t value,
...
static int valid_clock_result(const struct kexe_shared_v7 *shared, int64_t value) {
...
static int64_t clock_error_result(struct kexe_context_v7 *context,
...
static int64_t clock_success_result(struct kexe_context_v7 *context,
...
static int64_t hosted_clock_v1(struct kexe_context_v7 *context, int64_t request) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
...
static int valid_typed_value(struct kexe_context_v7 *context,
...
static int64_t ds_result_facet(struct kexe_context_v7 *context, int64_t id) {
  return checked_pair_new(context, DS_RES_FACET,
                          checked_pair_new(context, id, 0));
}

static int64_t ds_result_retracted(struct kexe_context_v7 *context,
                                   int64_t count) {
  return checked_pair_new(context, DS_RES_RETRACTED,
                          checked_pair_new(context, count, 0));
}

static int64_t ds_result_asserted(struct kexe_context_v7 *context,
...
static int64_t ds_result_matches(struct kexe_context_v7 *context,
...
static int64_t ds_notice_handle(struct kexe_context_v7 *context, int kind) {
  const char *text = kind == 1 ? ds_retract_notice : ds_assert_notice;
  return intern_utf8(context, (const uint8_t *)text, strlen(text));
}

static int64_t ds_empty_handle(struct kexe_context_v7 *context) {
  return intern_utf8(context, (const uint8_t *)ds_empty, strlen(ds_empty));
}

static int64_t dataspace_inject(struct kexe_context_v7 *context,
                                int64_t request) {
...
static int64_t ui_commit_inject(struct kexe_context_v7 *context,
                                int64_t request) {
  int64_t base_rev, rest, nodes, tail;
  uint64_t length = 0;
  const int64_t *items = NULL;
...
static int64_t ui_event_inject(struct kexe_context_v7 *context,
                               int64_t request) {
  int64_t after, tail;
...
static int64_t env_read_provider(struct kexe_context_v7 *context,
                                 int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t io_write_provider(struct kexe_context_v7 *context,
                                 int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  if (!read_string_handle(context, request, &bytes, &length)) {
...
static int64_t io_write_error_provider(struct kexe_context_v7 *context,
                                       int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  if (!read_string_handle(context, request, &bytes, &length)) {
...
static int64_t cli_args_provider(struct kexe_context_v7 *context,
                                 int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  if (!read_string_handle(context, request, &bytes, &length)) {
...
static int64_t fs_app_data_exists_provider(struct kexe_context_v7 *context,
                                           int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_read_provider(struct kexe_context_v7 *context,
                                         int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  char target[4096], candidate[4096];
...
static int64_t fs_app_data_write_provider(struct kexe_context_v7 *context,
                                          int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t kexe_answer_bool(struct kexe_context_v7 *context, int ok) {
...
static int64_t fs_app_data_stat_provider(struct kexe_context_v7 *context,
                                         int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_chmod_provider(struct kexe_context_v7 *context,
                                          int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_mkdir_provider(struct kexe_context_v7 *context,
                                          int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_unlink_provider(struct kexe_context_v7 *context,
                                           int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_rmdir_provider(struct kexe_context_v7 *context,
                                          int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_rename_provider(struct kexe_context_v7 *context,
                                           int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
...
static int64_t fs_app_data_range_read_provider(struct kexe_context_v7 *context,
                                               int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  if (!read_string_handle(context, request, &bytes, &length) || bytes == NULL) {
...
static int64_t fs_browse_provider(struct kexe_context_v7 *context,
                                  int64_t request) {
  const uint8_t *bytes = NULL;
  uint64_t length = 0;
  char target[4096], candidate[4096];
...
static int64_t checked_typed_cap_call(struct kexe_context_v7 *context,
                                      uint64_t id, uint64_t request_kind,
                                      uint64_t result_kind, int64_t request) {
  if (context == NULL || context->version != 7 || id > 255 ||
...
static int64_t checked_string_equal(struct kexe_context_v7 *context,
...
static int64_t checked_string_index_of(struct kexe_context_v7 *context,
...
static int64_t checked_arena_enter(struct kexe_context_v7 *context) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_arena_leave(struct kexe_context_v7 *context) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_string_compare(struct kexe_context_v7 *context,
                                      int64_t handle_a, int64_t handle_b) {
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
  int64_t offset_a = checked_pair_get(context, handle_a, 0);
  int64_t length_a = checked_pair_get(context, handle_a, 1);
...
static int64_t checked_string_fold_ascii(struct kexe_context_v7 *context,
                                         int64_t handle) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
...
static int64_t checked_string_scan_blank(struct kexe_context_v7 *context,
...
static int64_t checked_string_find_blank(struct kexe_context_v7 *context,
                                         int64_t handle, int64_t from) {
  return checked_string_scan_blank(context, handle, from, 1, 0);
}

static int64_t checked_string_skip_blank(struct kexe_context_v7 *context,
                                         int64_t handle, int64_t from) {
  return checked_string_scan_blank(context, handle, from, 0, 1);
}

static int64_t checked_string_concat(struct kexe_context_v7 *context,
                                     int64_t handle_a, int64_t handle_b) {
  struct kexe_shared_v7 *shared = (struct kexe_shared_v7 *)context;
  if (context == NULL || context->version != 7) { raise(SIGILL); return 0; }
  int64_t offset_a = checked_pair_get(context, handle_a, 0);
 ...
 *      "code-point boundary". */
static int64_t checked_string_substring(struct kexe_context_v7 *context,
...
static int64_t checked_string_code_point_at(struct kexe_context_v7 *context,
...
static int write_supervisor_report(const struct kexe_shared_v7 *shared,
                                   int child_status,
