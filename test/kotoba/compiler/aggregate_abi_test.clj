...
(deftest pinned-closure-carries-the-complete-native-boundary
  ;; dd7fe0c is kotoba-native ADR-0032: the record result check reads tail
  ;; position instead of the whole body, which is what puts murakumo's 33
  ;; shipped cores back at 33/33 on both ISAs (they had been at 27/33).
