(ns scripts.test-nbb-fuel-estimate
  "Launcher for `test/nbb/fuel-estimate.cljs`, mirroring
  `scripts/test-nbb-native-fuel-diagnostics.cljs`: `clojure -Spath -M:test`
...
(let [resolved (lib/run "clojure" ["-Spath" "-M:test"])
      ...
      result (.spawnSync child js/process.execPath
                         (clj->js [nbb-cli "--classpath" classpath
                                   (lib/join lib/root "test" "nbb" "fuel-estimate.cljs")])
