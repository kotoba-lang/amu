(ns scripts.test-nbb-state-provider
  "Launcher for `test/nbb/state-provider.cljs` (W5 family-4 first slice /
  ADR 0088), mirroring `scripts/test-nbb-log-provider.cljs`."
...
(let [resolved (lib/run "clojure" ["-Spath" "-M:test"])
      ...
      result (.spawnSync child js/process.execPath
                         (clj->js [nbb-cli "--classpath" classpath
                                  (lib/join lib/root "test" "nbb" "state-provider.cljs")])
