(ns scripts.test-nbb-http-ingress-provider
  "Launcher for `test/nbb/http-ingress-provider.cljs` (W5 family-3 / ADR 0097)."
...
(let [resolved (lib/run "clojure" ["-Spath" "-M:test"])
      ...
      result (.spawnSync child js/process.execPath
                         (clj->js [nbb-cli "--classpath" classpath
                                   (lib/join lib/root "test" "nbb"
                                             "http-ingress-provider.cljs")])
