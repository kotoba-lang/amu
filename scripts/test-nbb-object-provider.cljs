(ns scripts.test-nbb-object-provider
  "Launcher for `test/nbb/object-provider.cljs` (W5 stream-object dual-runtime
  first slice / ADR 0095)."
...
(let [resolved (lib/run "clojure" ["-Spath" "-M:test"])
      ...
      result (.spawnSync child js/process.execPath
                         (clj->js [nbb-cli "--classpath" classpath
                                   (lib/join lib/root "test" "nbb" "object-provider.cljs")])
