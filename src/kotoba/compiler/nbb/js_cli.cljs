(ns kotoba.compiler.nbb.js-cli
  ...
  `test/nbb/js_parity.cljs` here against the JVM-compiled
  ...
  consumers read them, they do not diff their text -- `test/nbb/js_parity.cljs`
